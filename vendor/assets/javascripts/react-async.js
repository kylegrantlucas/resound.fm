;(function(root, factory) {
  ...
  return (function e(t, n, r) {
    ...
    for (var o = 0; o < r.length; o++) return s(r[o]);
    return s
  })({
    1: [function(__browserify__, module, exports) {
      "use strict";
      ...
      "./lib/BaseMixin": 2,
      "./lib/getComponentFingerprint": 3,
      "./lib/isAsyncComponent": 4,
      "./lib/prefetchAsyncState": 5
    }],
    2: [function(__browserify__, module, exports) {
      ...
      var BaseMixin = {
        ...
        componentDidMount: function() {
          ...
          invariant(
            isAsyncComponent(this), "%s uses ReactAsync.Mixin and should provide getInitialStateAsync(cb) method",
            this.displayName);
    ...
    5: [function(__browserify__, module, exports) {
      ...
      function prefetchAsyncState(component, cb) {
        ...
        invariant(
          isAsyncComponent(component), "%s should be an async component to be able to prefetch async state, " + "but getInitialStateAsync(cb) method is missing or is not a function",
        ...
        getInitialStateAsync.call(component, function(err, asyncState) {
          ...
          cb(null, cloneWithProps(component, {
